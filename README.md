...
<ul>
  ...
  <li>🧪 <strong>Testing & Quality:</strong> Zero-regression strategy with +1200 tests using Vitest/Supertest (Backend) and Jest/RNTL (Frontend), including automated Swagger/OpenAPI documentation testing.</li>
</ul>
